...
angular.module('guthub', ['directives', 'services']).
  config(function($routeProvider) {
    $routeProvider.
      ...
      when('/edit/:recipeId', {controller:EditRecipeCtrl, resolve:EditRecipeCtrl.resolve, templateUrl:'/views/editRecipe.html'}).
      when('/view/:recipeId', {controller:ViewRecipeCtrl, resolve:ViewRecipeCtrl.resolve, templateUrl:'/views/viewRecipe.html'}).
      when('/new', {controller:NewRecipeCtrl, templateUrl:'/views/editRecipe.html'}).
